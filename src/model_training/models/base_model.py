...
class BaseSequenceModel(BaseSepsisModel):
    def build_and_train(self, df_train, df_val):
        ...
        df_train_scaled[self.features] = self.scaler.fit_transform(
            df_train[self.features]
        )
        df_val_scaled[self.features] = self.scaler.transform(
            df_val[self.features]
        )
    ...
    def predict_proba(self, df_test):
        ...
        df_test_scaled[self.features] = self.scaler.transform(
            df_test[self.features]
        )
